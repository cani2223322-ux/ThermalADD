...
public class TabAugmentsCharger extends GuiSideTab {
    ...
    private final ContainerAdvancedCharger container;

    public TabAugmentsCharger(GuiAdvancedCharger gui, ContainerAdvancedCharger container) {
