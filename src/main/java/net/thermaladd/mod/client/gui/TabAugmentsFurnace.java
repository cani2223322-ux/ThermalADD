...
/** Same 3x3 augment grid as {@link TabAugments} (the Pulverizer's), just wired to the Furnace's own tile/container. */
public class TabAugmentsFurnace extends GuiSideTab {
    ...
    public TabAugmentsFurnace(GuiAdvancedFurnace gui, ContainerAdvancedFurnace container) {
