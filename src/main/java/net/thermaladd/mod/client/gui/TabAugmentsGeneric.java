...
/** "Augments" tab for the TileSingularityMachine family - same 3x3 layout as TabAugments. */
public class TabAugmentsGeneric extends GuiSideTab {
    ...
    private final ContainerSingularityMachine container;

    public TabAugmentsGeneric(TabbedMachineGui gui, ContainerSingularityMachine container) {
