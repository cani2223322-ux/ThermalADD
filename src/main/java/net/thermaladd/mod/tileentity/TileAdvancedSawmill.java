 ...
 */
public class TileAdvancedSawmill extends TileEntity
    ...
    public static int BASE_ENERGY_PER_TICK = 40;
    ...
    public String getDataType() {
        return "tile.thermaladd.advancedSawmill";
    }
    ...
    /** One 16-bit half of a line's progress, as the container sends it - see ContainerAdvancedSawmill. */
    ...
    private boolean tryProcess(int line) {
        ...
        if (progress[line] < progressMax[line]) {
            ...
            int energyCost = EnergyMath.tickCost(BASE_ENERGY_PER_TICK * speedEnergyMod * secondaryEnergyPct / 100, step, remaining);
